...
const mockConversations = [
  ...
  { id: 4, name: "David", lastMessage: "Are you coming to the party?", number: 5 },
  { id: 5, name: "Eva", lastMessage: "I finished the report.", number: 1 },
  { id: 6, name: "Frank", lastMessage: "Can you send me the files?", number: 2 },
  { id: 7, name: "Grace", lastMessage: "Great job on the presentation!", number: 7 },
  ...
  { id: 11, name: "Kevin", lastMessage: "How’s the new project going?", number: 5 },
];
